@php
    ...
    $normalizedState = $getNormalizedState();
@endphp
...
>
    <div
        ...
        x-data="leafletMapEntry({
            location: {{ json_encode($normalizedState) }},
            config: {
    ...
    >
        <div class="relative w-full mx-auto rounded-lg overflow-hidden shadow bg-gray-50 dark:bg-gray-700">
            ...
            <div class="p-4 bg-gray-50 border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600" x-show="selectedCoordinates && selectedCoordinates.lat !== null && selectedCoordinates.lng !== null">
                <div class="flex items-center">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-200">
                        ...
                        <span class="font-medium" x-text="selectedCoordinates && selectedCoordinates.lat !== null ? selectedCoordinates.lat.toFixed(6) : ''"></span>,
                        <span class="font-medium" x-text="selectedCoordinates && selectedCoordinates.lng !== null ? selectedCoordinates.lng.toFixed(6) : ''"></span>
                    </p>
                </div>
            </div>
        </div>
